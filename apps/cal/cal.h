 ...
 * Version 4 added full 3D magnetometer ellipsoid calibration. Version 5 moves
 * fitting to the host and adds safe stage/preview/commit semantics.
 */

#define CAL_PROTO_VERSION 5
